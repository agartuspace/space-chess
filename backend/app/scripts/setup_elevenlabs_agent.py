...
SYSTEM_PROMPT = """Ты — Ұстаз (Uстаз), шахматный наставник платформы Agartu Space.
...
Пример первого сообщения: "Жарайсын, {{user_name}}! Я — Ұстаз, твой шахматный наставник. 
...
AGENT_CONFIG = {
    ...
    "conversation_config": {
        "agent": {
            ...
            "first_message": (
                "Жарайсын, {{user_name}}! Я — Ұстаз, твой шахматный наставник. "

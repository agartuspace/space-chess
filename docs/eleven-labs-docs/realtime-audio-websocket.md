...
subtitle: >-
This guide shows you how to generate audio in real-time via a WebSocket
connection.
-----------
...
<Note>
  ...
  For **Eleven v3** dialogue over a WebSocket, see [Realtime Text to
...
<img src="file:17426404-4dde-4f7a-8f18-ad4da47c4abe" />
...
<img src="file:9151d0a2-64d8-44d0-955e-d3346edb2115" />
...
<CardGroup cols={2}>
  <Card title="TTS streaming" icon="file:229118b6-6f05-4376-94c3-7041287a4174" href="/docs/eleven-api/guides/how-to/text-to-speech/streaming">
    Use HTTP streaming when input text is available up-front rather than generated in real time.
  </Card>

  <Card title="Latency optimization" icon="duotone gauge" href="/docs/eleven-api/guides/how-to/best-practices/latency-optimization">
